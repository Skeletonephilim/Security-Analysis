...
Same kit as a loud AD Purple box, but you read it from clay (`$MFT`/Sysmon) instead of typing it. Loudest move was not UAC bypass — it was cleartext creds in process create + LOLBin download pattern SOC already signatures.
